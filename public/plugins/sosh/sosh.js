...
(function(root, factory) {
  ...
  function getSitesHtml (sites) {
    ...
    for(var i = 0; i < length; i++) {
      ...
      if (site) {
        html += '<a class="sosh-item '+key+'" data-site="'+key +'" title="分享到'+site.name+'" href="javascript:;"><em class="sosh-item-icon">'+site.icon+'</em><span class="sosh-item-text">'+site.name+'</span></a>';
      }
    }
    return html;
  }
